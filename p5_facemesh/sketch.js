let sketch = function(p){
  ...
  p.setup = function(){
    ...
    edit_button = p.createButton("編輯模式 off");
  ...
  p.draw = function(){
    ...
    fill_H_Value.html("填滿 色相: " + fill_H_Slider.value());
    fill_S_Value.html("填滿 飽和度: " + fill_S_Slider.value());
    fill_B_Value.html("填滿 明度: " + fill_B_Slider.value());
    fill_O_Value.html("填滿 透明值: " + fill_O_Slider.value());

    stroke_H_Value.html("線段 色相: " + stroke_H_Slider.value());
    stroke_S_Value.html("線段 飽和度: " + stroke_S_Slider.value());
    stroke_B_Value.html("線段 明度: " + stroke_B_Slider.value());
    stroke_O_Value.html("線段 透明值: " + stroke_O_Slider.value());
  }
  ...
  p.toggleEdit = function(){
    ...
    if(isEditMode == true){
      edit_button.html("編輯模式 on");
    }else if(isEditMode == false){
      edit_button.html("編輯模式 off");
    }
  }
  ...
  p.screenShot = function(){
    ...
    let filename = year + month + day + '-' + hours + minutes + seconds + '.png';
    //saveCanvas(filename);
